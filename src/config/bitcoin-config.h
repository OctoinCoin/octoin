...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The OctoinCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "OctoinCoin Core"

/* Copyright year */
#define COPYRIGHT_YEAR 2017

/* build with lightning (enable by default) */
/* #undef ENABLE_LIGHTNING */

/* build with qt translations (disabbled by default) */
/* #undef ENABLE_QT_TRANSLATIONS */
...
#define PACKAGE_BUGREPORT "https://github.com/OctoinCoin/octoin"
...
#define PACKAGE_URL "http://octoin.org/"
