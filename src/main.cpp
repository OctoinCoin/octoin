...
#if defined(NDEBUG)
# error "OctoinCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "OctoinCoin Signed Message:\n";
