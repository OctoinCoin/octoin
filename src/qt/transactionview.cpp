...
TransactionView::TransactionView(const PlatformStyle *platformStyle, QVBoxLayout *layout, BitcoinGUI *_gui, QWidget *parent) :
    QWidget(parent), gui(_gui), model(0), transactionProxyModel(0),
