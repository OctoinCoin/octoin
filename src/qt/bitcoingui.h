...
private:
    ...
    QAction *bonusCodeTab;  //octoin
    QAction *shareDialog;   //octoin
    QAction *restoreWallet; //octoin
    QAction *lock;          //octoin
    QAction *unlock;        //octoin
    QAction *mining;        //octoin
    QAction *update;        //octoin
    QAction *lightning;     //octoin
#ifdef ENABLE_LIGHTNING
    QProcess lightningProcess; //octoin
#endif
...
private Q_SLOTS:
    ...
    /** start eclair (Lightning client for occ) */
    void startLightning();
};
