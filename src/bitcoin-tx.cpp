...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s octoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  octoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded octoin transaction") + "\n" +
              "  octoin-tx [options] -create [commands]   " + _("Create hex-encoded octoin transaction") + "\n" +
              "\n";
