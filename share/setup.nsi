...
!define MUI_ICON "/usr/src/octoin/share/pixmaps/bitcoin.ico"
!define MUI_WELCOMEFINISHPAGE_BITMAP "/usr/src/octoin/share/pixmaps/nsis-wizard.bmp"
!define MUI_HEADERIMAGE
!define MUI_HEADERIMAGE_RIGHT
!define MUI_HEADERIMAGE_BITMAP "/usr/src/octoin/share/pixmaps/nsis-header.bmp"
...
!define MUI_UNWELCOMEFINISHPAGE_BITMAP "/usr/src/octoin/share/pixmaps/nsis-wizard.bmp"
...
OutFile /usr/src/octoin/octoin-${VERSION}-win-setup.exe
!if "" == "64"
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File /usr/src/octoin/release/octoin-qt
    File /oname=COPYING.txt /usr/src/octoin/COPYING
    File /oname=readme.txt /usr/src/octoin/doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File /usr/src/octoin/release/octoind
    File /usr/src/octoin/release/octoin-cli
    SetOutPath $INSTDIR\doc
    File /r /usr/src/octoin/doc\*.*
    SetOutPath $INSTDIR
